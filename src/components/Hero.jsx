...
import { Github, Linkedin, Mail, Send, Download, ChevronDown, FileText } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left order-2 md:order-1">
            <div className="mb-8">
              <p className="text-[#00ff88] font-poppins text-sm md:text-base tracking-[0.3em] uppercase mb-3">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-orbitron mb-4 min-h-[80px] md:min-h-[100px]">
                <span
                  ...
                  style={{ textShadow: '0 0 40px rgba(0, 255, 240, 0.4), 0 0 80px rgba(0, 255, 136, 0.2)' }}
                >
                  {displayText}
                </span>
              ...
              >
                Configuring reliable networks. Troubleshooting hardware &amp; software. Keeping systems up, secure, and connected 24/7.
              </motion.p>
            </div>
            ...
            >
              ...
              <Link to="/resume">
                <Button
                  className="w-full bg-[#00ff88] text-[#0a0f1f] hover:bg-[#00ffd1] font-poppins px-8 py-6 text-lg shadow-[0_0_20px_rgba(0,255,136,0.3)] hover:shadow-[0_0_30px_rgba(0,255,136,0.5)] transition-all duration-300 flex items-center justify-center gap-2"
                >
                  <FileText size={20} />
                  View Resume
                </Button>
          ...
          >
            ...
            >
              ...
              <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
                ...
                <img
                  src="https://github.com/amit-kumar84/amit-kumar84.github.io/blob/33de0f3202b69afa9ac708dc9cf44dda4d523096/static/profile.png?raw=true"
                  alt="Amit Kumar - IT Infrastructure Engineer"
